...
class UploadFirmwareProtocol {

    private final static int UPLOAD_FINISHED = 1;
    private final static int ERROR_FINISHED = 2;
    private final static int UPLOAD_PROGRESS = 3;
    ...
    private static class MyHandler extends Handler {
        ...
        MyHandler(UploadFirmwareProtocol myClassInstance) {
